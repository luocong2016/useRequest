...
import type { CachedData } from "./utils";
...
export interface UseRequestOptions<TData, TParams extends any[]> {
  ...
  focusTimespan?: number | Ref<number>;

  // debounce
  debounceWait?: number | Ref<number | undefined>;
  debounceLeading?: boolean | Ref<boolean | undefined>;
  debounceTrailing?: boolean | Ref<boolean | undefined>;
  debounceMaxWait?: number | Ref<number | undefined>;

  // throttle
  throttleWait?: number | Ref<number | undefined>;
  throttleLeading?: boolean | Ref<boolean | undefined>;
  throttleTrailing?: boolean | Ref<boolean | undefined>;
  ...
  // ready
  ready?: Ref<boolean | undefined> | boolean;
